...
public class ExceptionsDemo {
	public static void main(String[] args) {
		...
		/*
		 * try { testMethod1(3); } catch (Exception e) { // TODO Auto-generated catch
		 * block e.printStackTrace(); System.out.println("catch block 1"); }
		 */
		...
		/*
		 * try { testMethod1(7); } catch (Exception e) { // TODO Auto-generated catch
		 * block e.printStackTrace(); System.out.println("catch block 1"); }
		 */
